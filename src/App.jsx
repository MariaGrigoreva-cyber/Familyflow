  ...
  return(
    <div style={shell}>
      ...
      <div style={{flex:1,display:'flex',flexDirection:'column',minHeight:0}} onTouchStart={handleTabTouchStart} onTouchEnd={handleTabTouchEnd}>
        {tab==='today'&&<TodayScreen state={appState} onToggle={handleToggle} onEditPayment={handleEditPayment} onEditTx={handleEditTx} onQuickMark={handleQuickMark} onWithdrawPiggy={()=>setShowWithdrawPiggy(true)} onOpenWhatIf={openWhatIf} onOpenSpendingCheck={openSpendingCheck} onUpgrade={cap=>openPaywall(cap||null,'today')} tourStep={tourStep} freeSpendableNow={cashFlowProjection.freeSpendableNow} weeklyBalances={cashFlowProjection.weeklyBalances} outlook={outlook} trialStage={trialStage} trialEndsAt={access.trialEndsAt} canForecast={canForecast} canSafeSpendable={canSafeSpendable} canScenarios={canScenarios} canSpendingCheck={canSpendingCheck} accessPending={accessPending}/>}
