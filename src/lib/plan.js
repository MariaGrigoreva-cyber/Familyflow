...
//
// Срок держим равным тому, что обещан новым регистрациям, — иначе витрина до
// регистрации показывала бы Pro дольше, чем человек получит после неё. Это
// именно согласование с обещанием, а НЕ источник срока: реальный триал живёт
// в trial_ends_at на сервере, и на него это значение не влияет никак.
const LOCAL_TRIAL_KEY = 'ff_local_trial_start';
const LOCAL_TRIAL_DAYS = 14;
