...
// Рабочий день по производственному календарю РФ: не суббота/воскресенье и не
// праздник. RU_HOLIDAYS покрывает 2025-2028 — за его пределами остаются только
// будни, это честнее, чем выдумывать праздники.
const isWorkday=d=>{const dw=d.getDay();return dw!==0&&dw!==6&&!RU_HOLIDAYS.has(localDateStr(d));};
...
const REPEAT_OPTS=[{id:'weekly',label:'Каждую нед.'},{id:'biweekly',label:'Раз в 2 нед.'},{id:'monthly',label:'Раз в месяц'},{id:'once',label:'Разовый'}];
...
const PRIVACY_URL='https://myfamilyflow.ru/privacy.html';
