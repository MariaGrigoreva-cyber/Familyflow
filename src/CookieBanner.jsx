  ...
  return(
    <div role="dialog" aria-label="Согласие на использование cookies"
      ...
      <p style={{margin:0,color:C.text2,fontSize:12.5,lineHeight:1.5,flex:'1 1 240px',minWidth:200}}>
        Мы используем cookies и Яндекс.Метрику для аналитики использования. Подробнее — в <a {...externalDocLinkProps(PRIVACY_URL)} style={{color:C.orangeD}}>политике конфиденциальности</a>.
      </p>
